...
module.exports = {
  ...
  img: (image) => {
    ...
    const aspect_ratio = (image.sizes["@1x-height"]/image.sizes["@1x-width"])*100;
    return outdent({ newline: '' })`
        <figure class='media-holder' style="--aspect: ${aspect}; --aspect-ratio: ${aspect_ratio}%; --aspect-mobile: ${aspect_ratio}%; --aspect-ratio-mobile: ${aspect_ratio}%">
           <img data-item-load
           alt="${image.title}"
