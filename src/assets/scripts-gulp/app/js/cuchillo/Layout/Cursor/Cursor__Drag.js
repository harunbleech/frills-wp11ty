class Cursor__Drag extends Cursor__Item{
  iconL;
  iconR;
  posL = 0;
  posR = 0;
  ...
  show(__axis = "x") {
    ...
    if(!this.isDragging) {
      TweenLite.to(this.iconL, .2, {size:this._sizeabs, ease: Power4.easeOut});
      TweenLite.to(this.iconR, .2, {size:this._sizeabs, ease: Power4.easeOut});
      TweenLite.to(this, .8, {posL: -20, posR: 20, ease: Power4.easeOut});
      TweenLite.to(this._arrow, .4, {size: 10, ease: Power4.easeOut});
      TweenLite.to(this._follower, .8, {size: 80, ease: Power4.easeOut});
    }
  }
  ...
  hide() {
    this._isOut = true;
    if(!this.isDragging) {
      TweenLite.to(this.iconL, .2, {size:0, ease: Power3.easeOut});
      TweenLite.to(this.iconR, .2, {size:0, ease: Power3.easeOut});
      TweenLite.to(this._arrow, .4, {size: this._arrow.default.size, ease: Power3.easeOut});
      TweenLite.to(this._follower, .3, {size: this._follower.default.size, ease: Power3.easeOut});
      TweenLite.to(this, .4, {
  ...
  drag() {
    ...
    TweenLite.to(this.iconL, .2, {size:this._sizeabs, ease: Power4.easeOut});
    TweenLite.to(this.iconR, .2, {size:this._sizeabs, ease: Power4.easeOut});
    TweenLite.to(this,.8, {posL:-14, posR:14, ease:Power4.easeOut});
    TweenLite.to(this._arrow, .4, {size: 10, ease: Power4.easeOut});
    TweenLite.to(this._follower,.8, {size:100, ease:Power4.easeOut});
  }
