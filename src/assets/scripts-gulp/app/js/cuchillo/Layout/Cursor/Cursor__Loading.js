class Cursor__Loading extends Cursor__Item{
  enabled = false;
  _follower;
  _dot;
  _idTimer;
  ...
  show() {
    ...
    this._idTimer = setTimeout(()=> {
      TweenLite.to(this._arrow, .1, {alpha: 0, ease: Power3.easeOut});
      TweenLite.to(this._follower, 1, {size: this._sizeabs, stroke: this._options.strokeBG, strokeAlpha: this._options.strokeAlpha, ease: Expo.easeOut});
      TweenLite.to(this._arrow, 1, {size: this._sizeabs, ease: Expo.easeOut});
      TweenLite.to(this._dot, 1, {size: this._sizeabs, ease: Expo.easeOut});
  ...
  hide() {
    ...
    TweenLite.to(this._dot, 1, {size: this._follower.default.size, stroke:this._follower.default.stroke, ease: Expo.easeInOut});
    TweenLite.to(this._arrow, 1, {size: this._arrow.default.size, alpha:this._arrow.default.alpha, ease: Expo.easeInOut});
    TweenLite.to(this._follower, 1, {size: this._follower.default.size, stroke: this._follower.default.stroke, ease: Expo.easeInOut});
